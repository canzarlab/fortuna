...
int main_kallisto(int argc, char *argv[], void* ALIGNER) {
  ...
  if (argc < 2) {
	...
	return 0;
        ...
        EMAlgorithm em(collection.counts, index, collection, fl_means, opt);
        //em.run(10000, 50, true, opt.bias); // LUKA: commented line
        ...
        //plaintext_writer(opt.output + "/abundance.tsv", em.target_names_, em.alpha_, em.eff_lens_, index.target_lens_);
        ...
        /*if (opt.pseudobam) {
          ...
          MP.processAln(em, false); // LUKA true to false
        }*/
